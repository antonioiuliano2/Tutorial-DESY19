...
if simEngine == "PG": 
  ...
  #overwriting the range for a quick test
  desytx = 0.10
  desyty = -0.05
  desytheta = ROOT.TMath.ATan(ROOT.TMath.Sqrt(desytx*desytx + desyty*desyty))
  desyphi = ROOT.TMath.ATan2(desyty,desytx)
  myPgun.SetThetaRange(desytheta*ROOT.TMath.RadToDeg(),desytheta*ROOT.TMath.RadToDeg())
  myPgun.SetPhiRange(desyphi*ROOT.TMath.RadToDeg(),desyphi*ROOT.TMath.RadToDeg())
