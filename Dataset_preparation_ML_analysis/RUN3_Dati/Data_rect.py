...
parser.add_argument("-ir","--inputremainder",dest="inputcsvremainder",help="input dataset in csv format with remainder of the shower (e.g. RUN5data_ric.csv)", required=True)
