...
/cvmfs/ship.cern.ch/SHiP-2021/2020/November/16/sw/slc7_x86-64/Python/v3.6.8-1/bin/python3 $DESYMACROS/Dataset_preparation_ML_analysis/RUN3_simulazioni/Rect_crescenti.py -n $LSB_JOBINDEX -is $DESYDIR/Iniz
io_sciame_RUN6.csv -if $DESYDIR/Rect -of $DESYDIR/Rect_crescenti

echo "Starting Theta code"
/cvmfs/ship.cern.ch/SHiP-2021/2020/November/16/sw/slc7_x86-64/Python/v3.6.8-1/bin/python3 $DESYMACROS/Dataset_preparation_ML_analysis/RUN3_simulazioni/Taglio_Theta.py -n $LSB_JOBINDEX -is $DESYDIR/Inizio
_sciame_RUN6.csv -if $DESYDIR/Rect_crescenti -of $DESYDIR/Theta
